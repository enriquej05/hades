  ...
  <div id="home" class="slider-area">
    <div class="bend niceties preview-2">
      <div id="ensign-nivoslider" class="slides">
        ...
        <img src="{{ asset('tema/img/slider/slider2.jpg') }}" alt="" title="#slider-direction-2" />
...
>>>>>>> 06e707c8ca5be425b5fa2ac9acc0da95555bb528
                ...
                <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                  <a class="ready-btn right-btn page-scroll" href="#services">Registrarse</a>
                  <a class="ready-btn page-scroll" href="#about">Iniciar Sesión</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="well-left">
            <div class="single-well">
              <a href="#">
								  <img src="{{ asset('tema/img/about/1.jpg') }}" alt="">
								</a>
            </div>
          </div>
        </div>
        ...
        <div class="team-top">
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="{{ asset('tema/img/team/1.jpg') }}" alt="">
									</a>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="{{ asset('tema/img/team/2.jpg') }}" alt="">
									</a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="{{ asset('tema/img/team/3.jpg') }}" alt="">
									</a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="{{ asset('tema/img/team/4.jpg') }}" alt="">
									</a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
  ...
  <div class="reviews-area hidden-xs">
    <div class="work-us">
      <div class="work-left-text">
        <a href="#">
						<img src="{{ asset('tema/img/about/2.jpg') }}" alt="">
					</a>
      </div>
      ...
      <div class="row">
        ...
        <div class="awesome-project-content">
              ...
              <div class="awesome-img">
                ...
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="{{ asset('tema/img/portfolio/1.jpg') }}">
                      <h4>Business City</h4>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 photo">
            <div class="single-awesome-project">
              <div class="awesome-img">
                ...
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="{{ asset('tema/img/portfolio/2.jpg') }}">
                      <h4>Blue Sea</h4>
                      <span>Photosho</span>
                    </a>
                  </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 design">
            <div class="single-awesome-project">
              <div class="awesome-img">
                ...
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="{{ asset('tema/img/portfolio/3.jpg') }}">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 photo development">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="{{ asset('tema/img/portfolio/4.jpg') }}" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="{{ asset('tema/img/portfolio/4.jpg') }}">
                      <h4>Creative Team</h4>
                      <span>Web design</span>
                    </a>
                  </div>
            ...
            <div class="single-awesome-project">
              <div class="awesome-img">
                ...
                <div class="add-actions text-center text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="{{ asset('tema/img/portfolio/5.jpg') }}">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 design photo">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="{{ asset('tema/img/portfolio/6.jpg') }}" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="{{ asset('tema/img/portfolio/6.jpg') }}">
                      <h4>Night Hill</h4>
                      <span>Photoshop</span>
                    </a>
                  </div>
